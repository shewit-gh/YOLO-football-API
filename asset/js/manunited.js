...
//fetching the data
fetch("https://football-web-pages1.p.rapidapi.com/fixtures-results.json?comp=1&team=13", {
	"method": "GET",
	"headers": {
...
// matchTable.appendChild(button);
 button .innerHTML= `  
<i class="fas fa-chevron-circle-down down" role="button" style = "color:#d20222;"></i>
