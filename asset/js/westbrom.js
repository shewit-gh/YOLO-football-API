...
//fetching the data
fetch("https://football-web-pages1.p.rapidapi.com/fixtures-results.json?comp=1&round=1&team=20", {
    "method": "GET",
    "headers": {
    ...
    .then(response => response.json().then(data => {
        ...
        button.innerHTML = `  
<i class="fas fa-chevron-circle-down down" role="button" style = "color:#002868;"></i>
